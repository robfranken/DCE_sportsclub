...
plot(mm, vline=1/2) + 
  ...
  scale_color_manual(labels = c("Travel time", "Training frequency", "Webpage statement", "Acquaintances", "% club members tertiary educated", "% contacts tertiary education", "% club members migration background", "% contactsmigration background"),
                  values = cbPalette)
...
(plot1 <- plot(amce_diagnostic1, group = "REFERENCE", legend_title = "Ref. cat.") + ftheme() + scale_colour_manual(values=cbPalette) + guides(color = FALSE))
```
...
p <- plot(plotdata) + 
  ...
  scale_y_discrete(labels = rev(newlabels)) +
  scale_color_manual(labels = c("Travel time", "Training frequency", "Webpage statement", "Acquaintances", "% club members tertiary educated", "% contacts tertiary education", "% club members migration background", "% contacts migration background"),
                  values = cbPalette)
